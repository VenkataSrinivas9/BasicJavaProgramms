 ...
 * called recursively, this time on the new array. Typically the array's size is
 * adjusted by manipulating a beginning and ending index. The algorithm exhibits
 * a logarithmic order of growth because it essentially divides the problem
 * domain in half with each pass.
 */
public class BinearySearch_RecursiveAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        int[] arr1 = { 2, 3, 9, 14, 18, 26, 33, 35, 45, 122, 156,187, 198, 234, 344, 444, 567, 876, 888, 899, 900, 976, 999 };
